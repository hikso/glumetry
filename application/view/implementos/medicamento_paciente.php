            ...
            <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Medicamentos del paciente</h4>
                            <span class="tools">
                    ...
                    <div class="widget-body">
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="gradeX odd">
                                ...
                                <td>acetaminofen</td>
                                <td>500 mg, amarisho</td>
                                <td>por la boca</td>
                            </tr><tr class="gradeX even">
                                <td class=" sorting_1"><input type="checkbox" class="checkboxes" value="1"></td>
                                <td>dolex</td>
                                <td class="hidden-phone">600 mg, verdillo</td>
                                <td>por la boca</td>
