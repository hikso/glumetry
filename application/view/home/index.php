         ...
         <ul class="nav pull-right top-menu" >
           ...
           <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <img src="<?php echo URL ?>img/avatar1_small.jpg" alt="">
    ...
    <div class="widget-body">
      ...
      <div class="row-fluid">
        ...
        <div class="metro-nav metro-fix-view">
         <div class="metro-nav-block nav-light-blue long">
          <a class="text-center" data-original-title="" href="<?php echo URL ?>base_alimentaria/consultarBasePaciente">
            <span class="value">
              <i class="icon-food"></i>
            </span>
          </a>
          <div class="status">Base alimentaria</div>
        </div>
      ...
      <div class="metro-nav">
        <div class="metro-nav-block nav-light-green">
          <a data-original-title="" href="<?php echo URL; ?>glucometria">
            <i class="icon-edit"></i>
          </a>
          <div class="info">Glucometria</div>
          <div class="status">Control de glucometrias</div>
        </div>
        <div class="metro-nav-block nav-block-green">
          <a data-original-title="" href="<?php echo URL; ?>estadisticas/estadisticasPaciente">
            <i class="icon-bar-chart"></i>
          </a>
          <div class="info">Estadisticas</div>
          <div class="status">Seguimientos</div>
        </div>
        <div class="metro-nav-block nav-block-blue">
          <a data-original-title="" href="<?php echo URL ?>dosificacion">
            <i class="icon-tint"></i>
          </a>
          <div class="info">Dosificación</div>
          <div class="status">Gestión de dosis</div>
        </div>

        <div class="metro-nav-block nav-light-blue double">
          <a data-original-title="" href="<?php echo URL ?>base_alimentaria">
            <i class="icon-building"></i>
          </a>
          <div class="info">Carbohidratos</div>
          <div class="status">Calculo de carbohidratos</div>
        </div>
