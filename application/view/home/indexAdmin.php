    ...
    <div class="widget-body">
      ...
      <div class="row-fluid">
        ...
        <div class="metro-nav metro-fix-view">
         <div class="metro-nav-block nav-light-blue long">
          <a class="text-center" data-original-title="" href="<?php echo URL ?>Usuarios">
            <span class="value">
      ...
      <div class="metro-nav">
        <div class="metro-nav-block nav-light-green double">
          <a data-original-title="" href="<?php echo URL ?>Datos">
            <i class="icon-gears"></i>
          </a>
          <div class="info">Configuración</div>
          <div class="status">Configuración del sistema</div>
        </div>
        ...
        <div class="metro-nav-block nav-light-blue double">
          <a data-original-title="" href="<?php echo URL ?>Usuarios/ConsultarUsuarios">
            <i class="icon-search"></i>
          </a>
          <div class="info">Consultar usuarios</div>
          <div class="status">Lista de usuarios</div>
        </div>
