var panel = 0;
    ...
    //Begin Update Genero
    var TipoDocumentoTabla;
    function ConsultaTipoDoc2(){        
        TipoDocumentoTabla = $('#tablaTipoDocumentos').dataTable();
    }
   ...
   $(document).ready(function() {
    ...
    function ConsultarGenero(){
        ...
        var jsonData = JSON.parse(data); 
         ctable.fnDestroy();
         ctable.children("tbody").html("");
         ctable.DataTable();
         for (var i = jsonData.length - 1; i >= 0; i--) {
            ctable.fnAddData( [
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarGenero2' id='"+jsonData[i].id_genero+"' onclick='cargarModalGenero2(this)'' class='edit'>Editar</a></td>"] );
            ctable.fnDraw();
         };
        ...
        var jsonData = JSON.parse(data); 
         ...
         for (var i = jsonData.length - 1; i >= 0; i--) {
            TipoDocumentoTabla.fnAddData([
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarTD' id='"+jsonData[i].id_tipo_documento+"' onclick='cargarTipoDocumentoEditar2(this)'' class='edit'>Editar</a></td>"]);
    ...
    //End Consultar Tipo Documento

    //Begin Consultar Estado Parto
     
    // //End Consultar Estado Parto

    var EstadoCivilTabla;
    function ConsultarEstadoCivil(){
        EstadoCivil = $('#tablaEstadoCivil').dataTable();
    }
    function ConsulgtarEstadoCivil2(){
        ...
        var jsonData = JSON.parse(data); 
         EstadoCivil.fnDestroy();
         EstadoCivil.children("tbody").html("");
         EstadoCivil.DataTable();
         for (var i = jsonData.length - 1; i >= 0; i--) {
            EstadoCivil.fnAddData([
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarEstCiv' id='"+jsonData[i].id_estado_civil+"' onclick='cargarEstCiv2(this)'' class='edit'>Editar</a></td>"]);
            EstadoCivil.fnDraw();
         };
        ...
        var jsonData = JSON.parse(data); 
         ...
         for (var i = jsonData.length - 1; i >= 0; i--) {
            TablaEspecializacion.fnAddData( [
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarEspcializacion' id='"+jsonData[i].id_especializacion+"' onclick='cargarEsp2(this)'' class='edit'>Editar</a></td>"] );
    ...
    // var TablaHabitosPersonales;
    // function ConsultarHabiPerso(){
    //     TablaHabitosPersonales = $('#tablaHabitosPersonales').dataTable();
    // }
    ...
    //              "<td class=''>"+jsonData[i].descripcion+"</td>"
    //             ,"<td class=''><a name='btnEditarHabPers' id='"+jsonData[i].id_habitos_personales+"' onclick='cargarHabPer2(this)'' class='edit'>Editar</a></td>"] );
    ...
    //     TablaFrecuencia = $('#tablaFrecuencia').dataTable();
    // }
    ...
    //              "<td class=''>"+jsonData[i].descripcion+"</td>"
    //             ,"<td class=''><a name='btnEditarFrecuencia' id='"+jsonData[i].id_frecuencia+"' onclick='cargarFrec2(this)'' class='edit'>Editar</a></td>"] );
    ...
    //     });
    // }
    var TablaEscolaridad;
    function CosultarEscolaridad(){
        TablaEscolaridad = $('#tablaEscolaridad').dataTable();
    }
        ...
        var jsonData = JSON.parse(data); 
         ...
         for (var i = jsonData.length - 1; i >= 0; i--) {
            TablaEscolaridad.fnAddData( [
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarEscolaridad' id='"+jsonData[i].id_escolaridad+"' onclick='cargarEsc2(this)'' class='edit'>Editar</a></td>"] );
    ...
    // var TablaTipoMedida;
    // function CosultarTipoMedida(){
    //     TablaTipoMedida = $('#TablaTipoMedidas').dataTable();
    // }
    // function ConsultarTipoMedida2(){
    //     $.ajax({
    //       dateType: 'html',
    //       Type: 'POST',
    //       url: url+"/Datos/ConsultarTipoMedida",

    //     }).done(function(data){
    //     var jsonData = JSON.parse(data); 
    //      TablaTipoMedida.fnDestroy();
    //      TablaTipoMedida.children("tbody").html("");
    //      TablaTipoMedida.DataTable();
    //      for (var i = jsonData.length - 1; i >= 0; i--) {
    //         TablaTipoMedida.fnAddData( [
    //              "<td class=''>"+jsonData[i].descripcion+"</td>"
    //             ,"<td class=''><a name='btnEditarFrecuencia' id='"+jsonData[i].id_tipo_medida+"' onclick='cargarTipoMed2(this)'' class='edit'>Editar</a></td>"] );
    //         TablaTipoMedida.fnDraw();
    //      };
    ...
    //     TablaMunicipios = $('#tablaMunicipios').dataTable();
    // }
    ...
    //     }).done(function(data){
    //     var jsonData = JSON.parse(data); 
    //      TablaMunicipios.fnDestroy();
    //      TablaMunicipios.children("tbody").html("");
    //      TablaMunicipios.DataTable();
    //      for (var i = jsonData.length - 1; i >= 0; i--) {
    //         TablaMunicipios.fnAddData( [
    //              "<td class=''>"+jsonData[i].departamento+"</td>"
    //              ,"<td class=''>"+jsonData[i].municipio+"</td>"
    //             ,"<td class=''><a name='btnEditarFrecuencia' id='"+jsonData[i].id_municipio+"' onclick='cargarMunicipio2(this)'' class='edit'>Editar</a></td>"] );
    //         TablaMunicipios.fnDraw();
    //      };
    ...
    function ConsultarDepartamentos(){
        TablaDepartamento = $('#tablaDepartamentos').dataTable();
    }
    function ConsultarDepartamento2(){
        ...
        var jsonData = JSON.parse(data); 
         TablaDepartamento.fnDestroy();
         TablaDepartamento.children("tbody").html("");
         TablaDepartamento.DataTable();
         for (var i = jsonData.length - 1; i >= 0; i--) {
            TablaDepartamento.fnAddData( [
                 "<td class=''>"+jsonData[i].descripcion+"</td>"
                ,"<td class=''><a name='btnEditarFrecuencia' id='"+jsonData[i].id_departamento+"' onclick='cargarMunicipio2(this)'' class='edit'>Editar</a></td>"] );
            TablaDepartamento.fnDraw();
         };
    ...
    // var TablaTipoAntecedente;
    // function ConsultarTipoAntecedente(){
    //     TablaTipoAntecedente = $('#TablaTipoAntecedente').dataTable();
    // }
    ...
    //     }).done(function(data){
    //     var jsonData = JSON.parse(data); 
    //      TablaTipoAntecedente.fnDestroy();
    //      TablaTipoAntecedente.children("tbody").html("");
    //      TablaTipoAntecedente.DataTable();
    //      for (var i = jsonData.length - 1; i >= 0; i--) {
    //         TablaTipoAntecedente.fnAddData( [
    //              "<td class=''>"+jsonData[i].descripcion+"</td>"
    //             ,"<td class=''><a name='btnEditarTipoAntecedente' id='"+jsonData[i].id_tipo_antecedente+"' onclick='cargarTipAnt2(this)'' class='edit'>Editar</a></td>"] );
    //         TablaTipoAntecedente.fnDraw();
    //      };
